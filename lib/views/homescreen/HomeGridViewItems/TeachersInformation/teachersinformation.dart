...
class Teachersinformation extends StatefulWidget {
  const Teachersinformation({super.key});

  @override
  State<Teachersinformation> createState() => _TeachersinformationState();
}

class _TeachersinformationState extends State<Teachersinformation> {
  @override
                    ...
                    children: [
                      ...
                      Transform.translate(
                        ...
                        child: GridView.builder(
                          itemCount: homcon.TeachersInformation.length,
                            ...
                            return Padding(
                              ...
                              child: custombuttom(onpresed: (){
                                //Get.to(
                                   ...
                                   // TeachersDepartment()
                                //     teachersallview(
                                //   textview: '${homcon.TeachersInformation[index]['items']}',
                                //   name: '${homcon.TeachersInformation[index]['buttonitem']}',
                                //   //items: '${homcon.TeachersInformation[index]['items']}',
                                //
                                // ));
                                //print('${homcon.departmentitems[index]['items']}',);
                                 Get.toNamed(
                                   homcon.TeachersInformation[index]['page'],
                                  );
                              }, text:  '${homcon.TeachersInformation[index]['buttonitem']}', textStyle: largeblack,),
                            );
                          },
                        ),
                      ),
