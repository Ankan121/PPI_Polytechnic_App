...
import 'package:ppi/views/homescreen/HomeGridViewItems/TeachersInformation/teachers.dart';
import 'package:ppi/views/homescreen/HomeGridViewItems/TeachersInformation/teachersinformation.dart';
...
class Teachersdepartment extends StatefulWidget {
  const Teachersdepartment({super.key});

  @override
  State<Teachersdepartment> createState() => _TeachersdepartmentState();
}

class _TeachersdepartmentState extends State<Teachersdepartment> {
  @override
                    ...
                    children: [
                      ...
                      Transform.translate(
                        ...
                        child: GridView.builder(
                          itemCount: homcon.techersdepartmentitems.length,
                          ...
                          itemBuilder: (context, index) {
                            ...
                            return Padding(
                              ...
                              child: custombuttom(onpresed: (){
                                Get.to(Teachers(items: homcon.techersdepartmentitems[index]['items'],buttonname: '${homcon.techersdepartmentitems[index]['buttonitem']}',));
                                print('${homcon.techersdepartmentitems[index]['items']}',);
                                // Get.toNamed(
                                //   homcon.departmentitems[index]['page'],
                                // );
                              }, text:  '${homcon.techersdepartmentitems[index]['buttonitem']}', textStyle: largeblack,),
                            );
                          },
                        ),
                      ),
