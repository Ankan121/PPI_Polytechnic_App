...
import 'package:ppi/views/homescreen/HomeGridViewItems/ppicareer/ppicareerallview.dart';
...
class PPICareer extends StatefulWidget {
  ...
  @override
  State<PPICareer> createState() => _PPICareerState();
}

class _PPICareerState extends State<PPICareer> {
                    ...
                    children: [
                      ...
                      Transform.translate(
                        ...
                        child: GridView.builder(
                          itemCount: homcon.ppicareer.length, // Teachers ডাটা অ্যাক্সেস
                          ...
                          itemBuilder: (context, index) {
                            ...
                            return Padding(
                              ...
                              child: InkWell(
                                onTap: (){
                                  Get.to(ppicareerallview(
                                    alllink: "${homcon.ppicareer[index]['link']}",
                                    name: "${homcon.ppicareer[index]['name']}",
                                  ));
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    Container(
                                      ...
                                      decoration: BoxDecoration(
                                        ...
                                        image: DecorationImage(
                                          image: AssetImage("${homcon.ppicareer[index]['img']}"),
                                          fit: BoxFit.fill,
                                        ),
                                    ...
                                    Text("${homcon.ppicareer[index]['name']}",style: largeblack,maxLines: 1,
